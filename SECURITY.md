...
see the [support matrix](docs/ahpy/support-matrix.md). The version lifetime,
ownership and backport rules are in the
[maintenance policy](docs/ahpy/maintenance.md).
...
CodeQL and dependency-review automation are defense-in-depth checks, not a
replacement for private reporting or the HPy ownership, ABI, sanitizer and
Debug Mode gates described by the maintenance policy.
