...
The current local gates pass all 946 focused coverage tests: 65 ownership-model,
57 Runtime API, 255 Universal-emitter, 62 compiler-seam, and 507 quality-tool
tests (two expected platform/tool availability skips on macOS). CPython 3.11
reports 9565/9565 backend lines (100.00%), 18279/34275 frontend-seam lines
(53.33%), and 8718/8718 quality-tool lines (100.00%); CPython 3.14.2 independently
reports 9451/9451 (100.00%), 18378/34380 (53.46%), and 8725/8725 (100.00%).
