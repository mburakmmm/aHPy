...
The current local gates pass all 584 focused coverage tests: 65 ownership-model,
56 Runtime API, 248 Universal-emitter, 62 compiler-seam, and 153 quality-tool
